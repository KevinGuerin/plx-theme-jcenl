...
<head>
    ...
    <title>Dixit - Our Contacts with sidebar</title>
        ...
        <div class="header_wrapper container">
            ...
            <nav>
                <ul class="menu">
                    ...
                    <li class="current-menu-parent"><a href="javascript:void(0)">CONTACTS</a>
                        <ul class="sub-menu">
                            <li><a href="contact_full.html">Full Width</a></li>
                            <li class="current-menu-item"><a href="contact_sidebar.html">With Sidebar</a></li>
                        </ul>
                    </li>
                </ul><!-- .menu -->
                <div class="clear"></div>
        ...
        <div class="content_wrapper">
        	<div class="page_title_block">
            	<div class="container">
                    ...
                    <div class="breadcrumbs"><a href="home.html">Home</a><span>Our Contacts</span></div>
                </div>
            </div>        
            <div class="container">
                        ...
                        <div class="row">
                            <div class="posts-block span9">
                                <div class="contentarea">
                                    ...
                                    <div class="row-fluid">
                                        <div class="span8 module_cont module_feedback_form">
                                            ...
                                            <form name="feedback_form" method="post" class="feedback_form">
                                                ...
                                                <div class="clear"></div>
                                                <textarea name="field-message" cols="45" rows="5" title="Message" class="field-message form_field" style="height:80px">Message</textarea>
                                                <div class="clear"></div>
                                        ...
                                        <div class="span4 module_cont module_contact_info">
                                            ...
                                            <div class="continfo_item"><span class="ico_contact ico_contact-address"></span>5512 Lorem Ipsum Vestibulum 666/13</div>
                                            <div class="continfo_item"><span class="ico_contact ico_contact-phone"></span>+1 800 789 50 12, +1 800 450 6935, +1 800 450 6940</div>
                                            <div class="continfo_item"><span class="ico_contact ico_contact-mail"></span><a href="mailto:mail@compname.com">mail@compname.com</a></div>
                                            <div class="continfo_item"><span class="ico_contact ico_contact-skype"></span>compname</div>
                                            <div class="continfo_item"><span class="ico_contact ico_contact-twitter"></span><a href="http://www.twitter.com/themedev">Twitter</a></div>
                                            <div class="continfo_item"><span class="ico_contact ico_contact-facebook"></span><a href="https://www.facebook.com/ThemeDev.me">Facebook</a></div>
                                            ...
                                            <div class="continfo_item"><span class="ico_contact ico_contact-youtube"></span><a href="http://www.youtube.com/user/gt3themes">YouTube</a></div>
                                        </div><!-- .module_cont -->                                        
									...
									<div class="module_line_trigger" data-option="hasShadow" data-background="#e1e1e1 url(img/bg_pattern1.png) repeat 0 0" data-top-padding="top_padding_normal" data-bottom-padding="module_normal_padding">
                                        <div class="row-fluid">
                                            <div class="span12 module_cont module_google_map module_medium_padding">                                               
                                                <iframe width="870" height="500" src="http://maps.google.ca/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=New+York&amp;sll=49.891235,-97.15369&amp;sspn=47.259509,86.923828&amp;ie=UTF8&amp;hq=&amp;hnear=New+York,+United+States&amp;ll=40.714867,-74.005537&amp;spn=0.019517,0.018797&amp;z=14&amp;iwloc=near&amp;output=embed"></iframe>
                                            </div><!-- .module_cont -->
                                        </div><!-- .row-fluid -->                                    
                                        
                                        <div class="row-fluid">
                                            <div class="span12 module_cont module_text_area module_normal_padding">
                                                <p>Nunc at pellentesque libero. Quisque quis elit eget enim facilisis gravida. Donec placerat dui nec orci tincidunt vitae tristique augue dictum. Duis nec leo vitae lorem rutrum tempor sit amet id quam sed los dui eleifend ipsum commodo luctus. Nulla et sem est. Aliquam facilisis lacinia massa, nec pretium risus pharetra at. Praesent eu sem et nunc ultrices tempor eu vel risus cum sociis natoque.</p>
                                            </div>
                                        </div><!-- .row-fluid -->
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12 module_cont module_partners">
											<div class="bg_title"><h4 class="headInModule">Our Partners</h4></div> 
                                            <div class="module_content sponsors_works carouselslider items4" data-count="4">
                                                <ul>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/cleanspace-retina-ready-business-wp-theme/3776000" target="_blank"><img src="img/pictures/partners1.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/charity-html5css3-website-template/3180454" target="_blank"><img src="img/pictures/partners2.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/yellowproject-multipurpose-retina-wp-theme/4066662" target="_blank"><img src="img/pictures/partners3.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/point-business-responsive-wp-theme/4319087" target="_blank"><img src="img/pictures/partners4.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/showroom-portfolio-retina-ready-wp-theme/3473628" target="_blank"><img src="img/pictures/partners5.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/incipiens-facebook-template/3540285" target="_blank"><img src="img/pictures/partners6.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/staple-bootstrap-responsive-web-template/3878835"><img src="img/pictures/partners7.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="#" target="_blank"><img src="img/pictures/partners8.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="http://themeforest.net/item/hq-photography-responsive-wp-theme/3200962" target="_blank"><img src="img/pictures/partners9.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item">
                                                            <a href="hhttp://themeforest.net/item/jdoe-responsive-photography-wordpress-theme/2570713" target="_blank"><img src="img/pictures/partners10.png" width="208" height="88" alt=""></a>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>                                        
                    ...
                    <div class="right-sidebar-block span3">
                        <aside class="sidebar">
                            ...
                            <div class="sidepanel widget_twitter">
                                <div class="bg_title"><h4 class="sidebar_header">Latest Tweets</h4></div>
